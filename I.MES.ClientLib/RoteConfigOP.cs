...
{
        public class RoteConfigOP
        {
            private string Name = "I.MES.Library.RoteConfigOP, I.MES.ServerLib, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null";
            public System.String addProdRoteConfig( I.MES.Models.MFG_RoteConfig roteConfig)
            {
                using (IChannel __channel = ChannelFactory.GetChannel())
                {
                    ...
                    __ps.Add(new Parameters(){Name = "roteConfig", Value = __compiler.Compile(roteConfig),TypeName = "I.MES.Library.EF.MFG_RoteConfig, I.MES.ServerEF, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null",IsRef=false });
                    BaseInformation_I __info = new BaseInformation_I()
                    {
                        ClassName = this.Name,
                        FunctionName = "addProdRoteConfig",
                        Parameters = __ps
                    };
            ...
            public void deleteRoteConfigByID( System.String roteConfigID)
            {
                using (IChannel __channel = ChannelFactory.GetChannel())
                {
                    __channel.Open();
                    ...
                    __ps.Add(new Parameters(){Name = "roteConfigID", Value = __compiler.Compile(roteConfigID),TypeName = "System.String, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089",IsRef=false });
                    BaseInformation_I __info = new BaseInformation_I()
                    {
                        ClassName = this.Name,
                        FunctionName = "deleteRoteConfigByID",
                        Parameters = __ps
                    };
